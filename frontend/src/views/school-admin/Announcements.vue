<template>
  <div class="admin-container">
    ...
    <el-card class="admin-card">
      ...
      <el-form :model="announcementForm" :rules="rules" ref="announcementForm">
        <el-form-item label="通知标题" prop="title">
          <el-input v-model="announcementForm.title" placeholder="请输入通知标题"></el-input>
        </el-form-item>
        <el-form-item label="通知内容" prop="content">
          <el-input v-model="announcementForm.content" type="textarea" placeholder="请输入通知内容" :rows="4"></el-input>
        </el-form-item>
        ...
        <el-form-item>
          <el-button type="primary" @click="publishAnnouncement">发布通知</el-button>
        </el-form-item>
      </el-form>
    </el-card>
      ...
      <template #header>
        <div class="card-header">
          ...
          <div class="card-actions">
            ...
            <el-input v-model="searchQuery" placeholder="搜索通知" class="search-input" prefix-icon="el-icon-search"></el-input>
          </div>
        </div>
      </template>
    ...
    <el-card class="admin-card mt-20">
      <template #header>
        <div class="card-header">
          <span class="card-title">通知统计</span>
        </div>
      </template>
