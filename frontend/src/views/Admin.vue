      ...
      <el-card class="overview-card">
        <template #header>
          <div class="card-header">
            <span class="card-title">管理概览</span>
        ...
        <div class="overview-content">
          <div class="overview-item animate-fade-in">
            ...
            <div class="overview-info">
              <h3>用户总数</h3>
              <p class="overview-value">{{ stats.totalUsers }}</p>
          ...
          <div class="overview-item animate-fade-in" style="animation-delay: 0.2s">
            ...
            <div class="overview-info">
              <h3>学校数量</h3>
              <p class="overview-value">{{ stats.totalSchools }}</p>
              <div class="progress-bar">
      ...
      <div class="left-content">
        ...
        <el-card class="mb-4 feature-modules-card animate-fade-in" style="animation-delay: 0.6s">
          ...
          <div class="feature-modules">
            <div class="feature-item hover-lift" @click="$router.push('/admin/users')">
              <div class="feature-icon plan-icon">
                <i class="el-icon-user"></i>
              </div>
              <span class="feature-text">用户管理</span>
            </div>
            <div class="feature-item hover-lift" @click="$router.push('/admin/schools')">
              <div class="feature-icon resource-icon">
                <i class="el-icon-office-building"></i>
              </div>
              <span class="feature-text">学校管理</span>
            </div>
            <div class="feature-item hover-lift" @click="$router.push('/admin/resources')">
              <div class="feature-icon goal-icon">
                <i class="el-icon-document"></i>
              </div>
              <span class="feature-text">资源管理</span>
            </div>
            <div class="feature-item hover-lift" @click="$router.push('/admin/settings')">
              <div class="feature-icon career-icon">
                <i class="el-icon-setting"></i>
              </div>
              <span class="feature-text">系统设置</span>
            </div>
            <div class="feature-item hover-lift" @click="$router.push('/admin/reports')">
              <div class="feature-icon community-icon">
                <i class="el-icon-data-analysis"></i>
              </div>
              <span class="feature-text">数据报表</span>
            </div>
            <div class="feature-item hover-lift" @click="$router.push('/admin/audit-logs')">
              <div class="feature-icon dashboard-icon">
                <i class="el-icon-notebook-2"></i>
              </div>
              <span class="feature-text">审计日志</span>
            </div>
            <div class="feature-item hover-lift" @click="$router.push('/admin/announcements')">
              <div class="feature-icon plan-icon">
                <i class="el-icon-bell"></i>
              </div>
              <span class="feature-text">通知管理</span>
            </div>
            <div class="feature-item hover-lift" @click="$router.push('/admin/backup-restore')">
              <div class="feature-icon resource-icon">
                <i class="el-icon-download"></i>
              </div>
              <span class="feature-text">备份恢复</span>
            </div>
          </div>
        </el-card>
      </div>
      ...
      <div class="right-content">
        ...
        <el-card class="mb-4 quick-access-card animate-fade-in" style="animation-delay: 0.8s">
          ...
          <div class="quick-access">
            <div class="quick-item hover-lift" @click="$router.push('/admin/users')">
              <div class="quick-icon user-icon">
                <i class="el-icon-user"></i>
              </div>
              <span class="quick-text">用户管理</span>
            </div>
            <div class="quick-item hover-lift" @click="$router.push('/admin/schools')">
              <div class="quick-icon school-icon">
                <i class="el-icon-office-building"></i>
              </div>
              <span class="quick-text">学校管理</span>
            </div>
            <div class="quick-item hover-lift" @click="$router.push('/admin/resources')">
              <div class="quick-icon resource-icon">
                <i class="el-icon-document"></i>
              </div>
              <span class="quick-text">资源管理</span>
            </div>
            <div class="quick-item hover-lift" @click="$router.push('/admin/settings')">
              <div class="quick-icon setting-icon">
                <i class="el-icon-setting"></i>
              </div>
              <span class="quick-text">系统设置</span>
            </div>
          </div>
        </el-card>
        ...
        <el-card class="mb-4 stats-card animate-fade-in" style="animation-delay: 1.2s">
          <template #header>
            <div class="card-header">
              <span class="card-title">系统数据</span>
              <el-button type="text" size="small" @click="$router.push('/admin/reports')" class="header-text-button">
                详细分析
              </el-button>
            </div>
          </template>
